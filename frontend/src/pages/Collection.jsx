  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10">
      ...
      <div className="min-w-60">
        ...
        {/* Category Filter */}
        <div
          className={`border border-gray-800 pl-5 py-3 mt-6 ${showFilter ? "" : "hidden"} sm:block`}
        >
        ...
        {/* SubCategory Filter */}
        <div
          className={`border border-gray-800 pl-5 py-3 my-5 ${showFilter ? "" : "hidden"} sm:block`}
        >
      ...
      <div className="flex-1">
        <div className="flex justify-between text-base sm:text-2xl mb-4 items-center">
          ...
          <select
            ...
            className="border-2 border-gray-700 bg-gray-900 text-sm px-2 py-2"
          >
